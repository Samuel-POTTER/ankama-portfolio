...
const Parcours = React.forwardRef<HTMLElement>((props, ref) => {
    return (
        ...
        >
            <h1 className='text-primary_dofus uppercase font-bebas text-5xl md:text-7xl'>mon parcours</h1>
            <div className=' flex flex-col items-center absolute top-1/4 translate-y-4'>
                <p className='text-primary_dofus text-2xl md:text-4xl  uppercase relative font-bebas'>lycee</p>
                <div className='w-[5px] bg-primary_dofus h-28'></div>
                <p className='text-primary_dofus text-2xl md:text-4xl  uppercase font-bebas'>universite</p>
                <div className='w-[5px] bg-primary_dofus h-28'></div>
                <p className='text-primary_dofus text-2xl md:text-4xl  uppercase font-bebas'>epitech</p>
            </div>
